...
class _AssessmentScreen2State extends State<AssessmentScreen2> {
  ...
  void _fetchQuestions() async {
    QuerySnapshot<Map<String, dynamic>> querySnapshot =
        await _firestore.collection('questions2').get();
    setState(() {
  ...
  Future<void> _updateAssessmentMarks(
    ...
    await _firestore.runTransaction((transaction) async {
      ...
      if (!doc.exists) {
        ...
        transaction.set(docRef, {'Assessment2': assessmentMarks});
      } else {
        // If the document exists, update Assessment1 only
        final currentData = doc.data()!;
        final currentAssessment2 = currentData['Assessment1'] ?? 0;
        ...
        transaction.update(docRef, {
          'Assessment2': assessmentMarks,
          'Assessment1': currentAssessment2,
