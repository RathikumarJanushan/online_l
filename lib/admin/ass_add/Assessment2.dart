...
class AddQuestionScreen2 extends StatefulWidget {
  @override
  _AddQuestionScreen2State createState() => _AddQuestionScreen2State();
}

class _AddQuestionScreen2State extends State<AddQuestionScreen2> {
  ...
  void _submitQuestion() async {
    ...
    try {
      await _firestore.collection('questions2').add({
        'question': question,
